...
export default function WhoAreWe() {
          return (
                    <div className='pb-10 md:px-12 my-10 px-6 md:my-16 py-12'>
                              <div className="pb-12">
                                        <h1 className='text-2xl md:text-3xl lg:text-4xl py-4 text-center font-lemonMilk text-primary'>Who Are We</h1>
                              ...
                              <div>
                                        ...
                                        <div className="mt-8 w-full space-y-7">
                                                  <p className='text-base md:text-lg font-monospaceTypewriter text-primary px-1'>
