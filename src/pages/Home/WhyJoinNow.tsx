          ...
          return (
                    <div className='pb-10 md:px-12 my-16 px-6 md:my-24 border border-r-0 lg:border-r py-12 lg:rounded-3xl'>
                              <div className='flex flex-col'>
                                        <h1 className='text-black text-2xl md:text-6xl text-center font-lemonMilk'>
                                                  Why Join Now?
                                        </h1>
                                        <p className='text-black pt-5 md:pt-8 w-full lg:w-4/5 mx-auto text-base md:text-lg text-center font-monospaceTypewriter'>
